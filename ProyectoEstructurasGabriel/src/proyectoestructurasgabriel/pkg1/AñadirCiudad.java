...
public class AñadirCiudad extends javax.swing.JFrame {
     ...
     */
    public AñadirCiudad(MyGraph g, String p) {
        initComponents();
        path = p;
        graph = g;
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(graph.actual_cities < 20){
            graph.NewCity(this.texto.getText());
            this.jTextArea1.setText(graph.showVertex());
            this.texto.setText("");
            graph.escribirArchivo(path);
        }else{
            JOptionPane.showMessageDialog(rootPane, "MAXIMO DE CIUDADES ALCANZADO");
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AñadirCiudad(graph, path).setVisible(true);
            }
        });
    }
